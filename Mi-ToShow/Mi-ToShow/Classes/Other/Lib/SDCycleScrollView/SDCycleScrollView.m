...
#pragma makr 设置显示图片的collectionView
- (void)setupMainView
{
    ...
    UICollectionView *mainView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, self.width , self.height) collectionViewLayout:flowLayout];
